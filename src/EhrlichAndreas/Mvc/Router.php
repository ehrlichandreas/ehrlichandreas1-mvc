 ...
 */
class EhrlichAndreas_Mvc_Router 
{
    ...
    public function addDefaultRoutes()
    {
        ...
        if (!$this->hasRoute('default'))
        {
            ...
            $compat = new EhrlichAndreas_Mvc_Route(array(), $dispatcher, $request);
     ...
     * @param  EhrlichAndreas_Mvc_Route $route     Instance of the route
     * @return EhrlichAndreas_Mvc_Router
     */
    public function addRoute($name, EhrlichAndreas_Mvc_Route $route)
    {
     ...
     *
     * @param EhrlichAndreas_Mvc_FrontController $controller
     * @return EhrlichAndreas_Mvc_Router
     */
     ...
     * @return boolean|EhrlichAndreas_Mvc_Router
     *              Returns a boolean if first param isn't set, returns an
     *              instance of EhrlichAndreas_Mvc_Router otherwise.
     *
     */
